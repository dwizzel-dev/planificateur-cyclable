...
function drawFiles($list, &$manager)
{
	...
	{ ?>
		<div style="width:100px; height:118px; position:relative;float:left;margin:12px;"><table width="100" cellpadding="0" cellspacing="0"><tr><td class="block">
...
<div style="width:100%;border:0px solid #ff0000;position:relative;float:left;">
