...
@auth:	Dwizzel
@date:	00-00-0000
@info:	default controller for config editing
...
$arrOutput['content']['title'] = _T('config');
...
$arrOutput['content']['config']['defined'] = $oConfig->getSiteConfig();

//la view
$oGlob->set('page_view', 'config');
