...
@auth:	Dwizzel
@date:	00-00-0000
@info:	default controller for datafields editing
...
$arrOutput['content']['title'] = _T('database fields');
...
//le dropdown
$arrOutput['content']['field-dropdown'] = $oDatafields->getDataFields();

//la view
$oGlob->set('page_view', 'datafields');
