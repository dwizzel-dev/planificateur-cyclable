...
@bugs:
	desc: bug with double returned line  in heades \r\n\r\n line 223
	date: 08-09-2017
*/
...
class Mailer {
	...
	var $mail_cc;
	var $mail_bcc;
	var $webmaster_email = EMAIL_ORIGINE_COURRIEL;
	...
	function build_message() {
		...
		if ($is_html) {
			...
			$this->headers .= "Content-Type: multipart/alternative;".LIBR." boundary=\"".$this->alternative_uid."\"".LIBR;
			if (!$is_attachment) {
				$this->headers .= "This is a multi-part message in MIME format.".LIBR;
			}
