...
@auth:	Dwizzel
@date:	00-00-0000
@info:	default controller for mot-de-passe-perdu page and default form process
...
// Create the form
$form = new JFormer('lost_password', array(
...
//show
$arrOutput['content']['lost-password-form'] = $form->output();
//clean
unset($form);
unset($section);	
