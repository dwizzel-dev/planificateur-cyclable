...
foreach($arrGrilles as $k=>$v){
	...
	foreach($arrGrilles[$k]['questions'] as $k2=>$v2){
		...
		//bulle aide	
		$arrGrilles[$k]['questions'][$k2]['bulles'] = $oGrille->getBulleByQuestionId($v2['id']);
		}
	}
...
$arrOutput['content']['javascript-grilles'] = array(
	...
	'keyvalue' => array(
		...
		'typeOrder' => $oGrille->getTypeListingOrder(),
...
$arrOutput['content']['javascript-recommandation'] = array();
